...
help:
	...
	@echo ""
	@echo "Docker Build:"
	@echo "  build-docker           Build using golang:1.27.1-trixie"
...
.PHONY: build clean test fmt lint build-all package install uninstall help build-docker build-all-docker install-deps-docker test-docker fmt-docker lint-docker
